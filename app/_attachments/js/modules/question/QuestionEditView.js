...
QuestionEditView = (function(_super) {
  ...
  QuestionEditView.prototype.render = function() {
    var assessmentName, checkOrRadio, customValidationCode, customValidationMessage, hint, i, linkedGridScore, name, option, optionHTML, optionTemplates, options, prompt, skipLogic, skippable, subtestName, type, _i, _len;
    ...
    if (type !== "open") {
      ...
      optionTemplates = Tangerine.templates.get("optionTemplates");
      for (i = _i = 0, _len = optionTemplates.length; _i < _len; i = ++_i) {
