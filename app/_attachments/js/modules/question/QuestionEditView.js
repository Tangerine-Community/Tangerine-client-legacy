...
QuestionEditView = (function(_super) {
  ...
  QuestionEditView.prototype.render = function() {
    var assessmentName, checkOrRadio, customValidationCode, customValidationMessage, hint, i, linkedGridScore, name, option, optionHTML, optionTemplates, options, prompt, skipLogic, skippable, subtestName, type, _len;
    ...
    if (type !== "open") {
      ...
      optionTemplates = Tangerine.templates.get("optionTemplates");
      for (i = 0, _len = optionTemplates.length; i < _len; i++) {
