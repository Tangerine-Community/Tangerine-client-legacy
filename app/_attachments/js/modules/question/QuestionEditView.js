...
QuestionEditView = (function(_super) {
  ...
  QuestionEditView.prototype.addOption = function() {
    ...
    if (optionListElements.length !== 0) {
      return $(optionListElements.pop()).scrollTo().find("input:first").focus();
    }
  };

  QuestionEditView.prototype.render = function() {
    var checkOrRadio, hint, i, linkedGridScore, name, option, optionHTML, options, prompt, skipLogic, skippable, type, _i, _len, _ref,
      _this = this;
