...
AccountView = (function(_super) {
  ...
  AccountView.prototype.render = function() {
    ...
    html = "      <button class='back navigation'>Back</button>      <h1>Account</h1>      <a href='#settings' class='navigation'><button class='navigation'>Settings</button></a>      <a href='#logs' class='navigation'><button class='navigation'>Logs</button></a>      <section>        <div class='label_value'>          <label>Name</label>          <div>" + this.user.name + "</div>        </div>      </section>      " + (groupSection || "") + "      </div><br>      <!--button class='command confirmation'>Report a bug</button>      <div class='confirmation' id='bug'>        <label for='where'>What broke?        <input id='where' placeholder='where'>        <label for='where'>What happened?        <input id='where' placeholder='what'>        <label for='where'>What should have happened?        <input id='should' placeholder='should'>        <button>Send</button>      </div-->      ";
    this.$el.html(html);
    this.renderGroups();
