...
AssessmentListView = (function(_super) {
  ...
  function AssessmentListView() {
    ...
    return AssessmentListView.__super__.constructor.apply(this, arguments);
  }
  ...
  AssessmentListView.prototype.render = function() {
    var assessment, groupList, groupsButton, html, importButton, newButton, oneView, publicList, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
    this.closeViews();
    this.views = [];
    ...
    this.$el.html(html);
    if (((_ref = this.collection) != null ? (_ref1 = _ref.models) != null ? _ref1.length : void 0 : void 0) > 0) {
      groupList = $('<ul>').addClass('assessment_list');
      _ref3 = (_ref2 = this.collection) != null ? _ref2.models : void 0;
    ...
    if (this.isAdmin && Tangerine.settings.context === "server") {
      ...
      if (((_ref4 = this["public"]) != null ? (_ref5 = _ref4.models) != null ? _ref5.length : void 0 : void 0) > 0) {
        publicList = $('<ul>').addClass('public_list assessment_list');
        _ref7 = (_ref6 = this["public"]) != null ? _ref6.models : void 0;
