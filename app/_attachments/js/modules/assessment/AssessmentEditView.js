...
AssessmentEditView = (function(_super) {
  ...
  AssessmentEditView.prototype.updateModel = function() {
    var doublesError, element, emptyError, i, j, rangeError, sequence, sequenceErrors, sequences, sequencesValue, subtestCount, tooFewError, tooManyError, validatedSequences, _i, _j, _len, _len1;
    ...
    if (!_.isEmpty(_.reject(_.flatten(sequences), function(e) {
      ...
      if (sequenceErrors.length === 0) {
        validatedSequences = ((function() {
          ...
          _results = [];
          for (_k = 0, _len2 = sequences.length; _k < _len2; _k++) {
  ...
  AssessmentEditView.prototype.render = function() {
    var arch, archiveChecked, i, key, notArchiveChecked, sequences, subKey, subValue, subtestLegend, subtestTypeSelect, value, _i, _len, _ref,
      _this = this;
    sequences = "";
    ...
    this.$el.find("#subtest_list").sortable({
      ...
      update: function(event, ui) {
        var id, li, _j, _len1, _ref1;
        _ref1 = (function() {
          var _k, _len1, _ref1, _results;
          _ref1 = this.$el.find("#subtest_list li");
          _results = [];
