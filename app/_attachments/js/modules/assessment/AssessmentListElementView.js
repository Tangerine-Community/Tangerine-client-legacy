...
AssessmentListElementView = (function(_super) {
  ...
  AssessmentListElementView.prototype.render = function() {
    var adminName, archiveClass, archiveSwitch, copyButton, deleteButton, deleteConfirm, downloadKey, duplicateButton, editButton, html, name, resultCount, resultsButton, runButton, selected, toggleButton, updateButton;
    ...
    if (this.isAdmin) {
      ...
      if (Tangerine.settings.context === "mobile") {
        ...
        if (this.isPublic) {
          ...
          html += "            <div class='assessment_menu'>              " + runButton + "              " + resultsButton + "              " + editButton + "              " + duplicateButton + "              " + deleteButton + "              " + downloadKey + "              " + deleteConfirm + "            </div>          ";
        }
      }
    } else {
