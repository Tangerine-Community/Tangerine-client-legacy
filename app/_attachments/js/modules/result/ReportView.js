...
ReportView = (function(_super) {
  ...
  ReportView.prototype.initialize = function(options) {
    ...
    return allResults.fetch({
      success: function(collection) {
        var correct, dev, id, incorrect, index, missing, person, result, subtestKey, subtestValue, _i, _j, _k, _len, _len2, _len3, _ref, _ref2, _ref3, _ref4;
  ...
  ReportView.prototype.render = function() {
    var colHeader, color, person, tableHTML, value, _i, _len, _ref, _ref2;
