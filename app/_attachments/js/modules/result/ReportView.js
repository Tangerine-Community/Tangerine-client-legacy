...
ReportView = (function(_super) {
  ...
  ReportView.prototype.initialize = function(options) {
    var aCorrect, correct, dev, devIndex, i, incorrect, index, item, missing, percentile, person, result, total, _i, _j, _k, _len, _len2, _len3, _len4, _ref, _ref2, _ref3, _ref4;
    this.table = [];
    aCorrect = 0;
    this.summary = {
    ...
    this.summary.aCorrect = Utils.round(this.summary.aCorrect / this.table.length, 2);
    _ref3 = this.table;
    for (_k = 0, _len3 = _ref3.length; _k < _len3; _k++) {
      person = _ref3[_k];
      this.summary.stdDev += Math.pow(person.pCorrect - this.summary.aCorrect, 2);
    }
    this.summary.stdDev = Utils.round(Math.pow(this.summary.stdDev / this.table.length, 0.5), 2);
    _ref4 = this.table;
  ...
  ReportView.prototype.render = function() {
    ...
    if (this.table.length > 0) {
      ...
      detailsHTML = "        <h4>Detailed Student Data Summary</h4>        <table border='3'>        <tr>          <td>Name</td>          <td>% Correct</td>          <td># Correct</td>          <td># Attempted</td>          <td>Total</td>          <td>%ile</td>          <td>Status</td>        </tr>      ";
      _ref = this.table;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        person = _ref[_i];
      ...
      detailsHTML += "</table>";
      summaryHTML = "<h4>Summary</h4>      <table border='3'>        <tr><td>Subtest Name</td>          <td>" + this.summary.name + "</td></tr>        <tr><td>Average (%)</td>           <td>" + this.summary.aCorrect + "</td></tr>        <tr><td>Standard Deviation (%)</td><td>" + this.summary.stdDev + "</td></tr>        <tr><td>Class Size</td>            <td>" + this.summary.classSize + "</td></tr>        <tr><td>Number of Questions</td>   <td>" + this.summary.totalItems + "</td></tr>        <tr><td>Students to watch</td>     <td>" + (this.summary.watchList.join(', ')) + "</td></tr>      </table>";
      this.$el.html("        " + summaryHTML + "        " + detailsHTML + "              <button class='navigation back'>Back</button>      ");
      return this.trigger("rendered");
    }
  };

  ReportView.prototype.getIndexFromPercentile = function(percentile) {
    var index;
