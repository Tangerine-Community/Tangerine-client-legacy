...
ReportView = (function(_super) {
  ...
  ReportView.prototype.initialize = function(options) {
    ...
    return allResults.fetch({
      success: function(collection) {
        var correct, dev, id, ids, incorrect, index, missing, person, result, subtestKey, subtestValue, _i, _j, _k, _len, _len2, _len3, _ref, _ref2, _ref3, _ref4;
  ...
  ReportView.prototype.render = function() {
    var colHeader, color, person, tableHTML, testStats, toHTML, value, _i, _len, _ref, _ref2;
    if (this.table.length > 0) {
      ...
      for (colHeader in _ref) {
        ...
        if (colHeader !== "Deviation") tableHTML += "<th>" + colHeader + "</th>";
      }
      tableHTML += "</tr>";
      _ref2 = this.table;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        ...
        for (colHeader in person) {
          ...
          if (colHeader !== "Deviation") tableHTML += "<td>" + value + "</td>";
        }
        tableHTML += "</tr>";
      }
      tableHTML += "</table>";
