...
ResultsView = (function(_super) {
  ...
  ResultsView.prototype.render = function() {
    ...
    html = "      <h1>" + (this.assessment.get('name')) + "</h1>      <h2>Save options</h2>      <div class='menu_box'>        " + (Tangerine.settings.context === "mobile" ? cloudButton : "") + "        " + (Tangerine.settings.context === "mobile" ? tabletButton : "") + "        " + csvButton + "        <button class='command'><a style='text-decoration: none; color:black' href='#csv_alpha/" + this.assessment.id + "'>CSV Beta</a></button>      </div>";
