    ...
    if ((this.results != null) && (this.results[0] != null)) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        orderMap = result.has("order_map") ? result.get("order_map") : (function() {
          _results = [];
          for (var _j = 0, _ref1 = result.attributes.subtestData.length - 1; 0 <= _ref1 ? _j <= _ref1 : _j >= _ref1; 0 <= _ref1 ? _j++ : _j--){ _results.push(_j); }
          return _results;
        }).apply(this);
        for (rawIndex = _k = 0, _ref2 = result.attributes.subtestData.length - 1; 0 <= _ref2 ? _k <= _ref2 : _k >= _ref2; rawIndex = 0 <= _ref2 ? ++_k : --_k) {
          ...
          subtestName = (_ref3 = subtest.name) != null ? _ref3.toLowerCase().dasherize() : void 0;
