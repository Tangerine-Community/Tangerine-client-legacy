...
StudentToDateView = (function(_super) {
  ...
  function StudentToDateView() {
    ...
    return StudentToDateView.__super__.constructor.apply(this, arguments);
  }
  ...
  StudentToDateView.prototype.initialize = function(options) {
    var i, j, milisecondsPerPart, subtest, subtestPart, subtests, subtestsByPart, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref;
    ...
    this.range = (function() {
      ...
      _results = [];
      for (i = _i = 1, _ref = this.currentPart; 1 <= _ref ? _i <= _ref : _i >= _ref; i = 1 <= _ref ? ++_i : --_i) {
        _results.push(i);
      }
      return _results;
    }).call(this);
  ...
  StudentToDateView.prototype.readyFlot = function() {
    var bucket, bucketKey, bucketType, flotArray, i, oneObject, subtests, _ref, _ref1, _ref2,
      _this = this;
    bucketType = this.bucketize(this.bucketList);
    _ref = this.subtestsByResultsBucket;
    for (bucketKey in _ref) {
      subtests = _ref[bucketKey];
      if (((_ref1 = subtests[0]) != null ? typeof _ref1.get === "function" ? _ref1.get("timer") : void 0 : void 0) > 0 && _.flatten(this.resultsByBucketByPart[subtests[0].get('resultBucket')]).length > 1) {
    ...
    this.flotData = [];
    _ref2 = this.flotArrays;
    for (bucket in _ref2) {
      flotArray = _ref2[bucket];
    ...
    return this.flotOptions = {
      ...
      "xaxis": {
        ...
        ticks: (function() {
          ...
          _results = [];
          for (i = _i = 1, _ref3 = this.currentPart; 1 <= _ref3 ? _i <= _ref3 : _i >= _ref3; i = 1 <= _ref3 ? ++_i : --_i) {
