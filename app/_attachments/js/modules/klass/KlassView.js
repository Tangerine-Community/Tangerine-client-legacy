...
KlassView = (function(_super) {
  ...
  KlassView.prototype.render = function() {
    var assessment, grade, html, stream, year, _i, _len, _ref, _ref1;
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      assessment = _ref[_i];
      html += "<li data-id='" + assessment.id + "'>" + (assessment.get('name')) + " - " + ((_ref1 = assessment.get('results')) != null ? _ref1.length : void 0) + "</li>";
    }
    html += "</ul>";
    this.$el.html(html);
