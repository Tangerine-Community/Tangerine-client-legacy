...
SubtestEditView = (function(_super) {
  ...
  SubtestEditView.prototype.render = function() {
    var assessmentName, dialog, enummerator, fontFamily, name, prototype, skippable, transition, _base;
