...
ObservationPrintView = (function(_super) {
  ...
  ObservationPrintView.prototype.initializeSurvey = function() {
    ...
    models = (function() {
      ...
      _results = [];
      for (i = _i = 1, _ref = parseInt(this.model.get('totalSeconds') / this.model.get('intervalLength')); 1 <= _ref ? _i <= _ref : _i >= _ref; i = 1 <= _ref ? ++_i : --_i) {
  ...
  ObservationPrintView.prototype.getSkipped = function() {
    var i, skippedResults, viewResult, _i, _ref;
    viewResult = this.skippableView.getSkipped();
    skippedResults = [];
    for (i = _i = 1, _ref = this.survey.models.length - 1; 1 <= _ref ? _i <= _ref : _i >= _ref; i = 1 <= _ref ? ++_i : --_i) {
      skippedResults.push({
        observationNumber: i,
        data: viewResult,
        saveTime: "skipped"
