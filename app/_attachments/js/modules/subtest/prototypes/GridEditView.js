...
GridEditView = (function(_super) {
  ...
  GridEditView.prototype.save = function() {
    ...
    return this.model.set({
      captureLastAttempted: this.$el.find("#capture_minute_item input:checked").val() === "true",
      endOfLine: this.$el.find("#capture_last_attempted input:checked").val() === "true",
      captureMinuteItem: this.$el.find("#end_of_line input:checked").val() === "true",
  ...
  GridEditView.prototype.render = function() {
    var autostop, captureLastAttempted, columns, endOfLine, items, minuteItem, randomize, timer, variableName;
