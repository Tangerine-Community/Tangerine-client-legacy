...
PrototypeSurveyView = (function(_super) {
  ...
  PrototypeSurveyView.name = 'PrototypeSurveyView';

  function PrototypeSurveyView() {
    return PrototypeSurveyView.__super__.constructor.apply(this, arguments);
  }
  ...
  PrototypeSurveyView.prototype.showErrors = function() {
    var first, i, message, qv, _i, _len, _ref, _results;
  ...
  PrototypeSurveyView.prototype.render = function() {
    var i, oneView, question, required, _i, _len, _ref;
    this.questions.sort();
