...
GridRunView = (function(_super) {
  ...
  GridRunView.prototype.endOfGridLineClick = function(event) {
    var $target, i, index, _i, _j, _ref, _ref1;
    if (this.mode === "mark") {
      $target = $(event.target);
  ...
  GridRunView.prototype.render = function() {
    var captureLastButton, disabling, done, firstRow, gridHTML, html, i, item, labelText, minuteItemButton, modeSelector, resetButton, startTimerHTML, stopTimerHTML, _i, _j, _len, _ref, _ref1;
    done = 0;
  ...
  GridRunView.prototype.showErrors = function() {
    ...
    if (this.timeRuning === true) {
      return Utils.midAlert(t("time still running"));
    }
  };
  ...
  GridRunView.prototype.getSkipped = function() {
    var i, item, itemResults, result, _i, _len, _ref;
    itemResults = [];
    _ref = this.items;
    for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
      item = _ref[i];
