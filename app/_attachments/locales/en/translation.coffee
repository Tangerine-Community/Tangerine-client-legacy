  ...
  "LoginView" :
    "message" :
      ...
      "challenge_explanation" : "Challenge questions are asked during password resetting. The user must produce the challenge response in order to reset the password."
